		...
		<div class="col-md-6">
         <div class="box box-success">
			...
			<div class="box-body">
		           ...
		           <?php echo $this->Form->create('ClassWiseAttendance',array("url"=>array("controller"=>"Attendance","action"=>"attendanceMonthReportList")));?>
					...
					<div class="form-group">	
						<div class="row">
							...
							<div class="col-md-6"><label>Month<span class="mandatory_fields"> * </span></label>
								<?php echo $this->Form->input('month',array('type'=>'select',"required","class"=>"form-control select_box",'empty'=>'Select Month',
								'label'=>false,'options'=>array('1'=>'January','2'=>'Febrauary','3'=>'March','4'=>'April',
