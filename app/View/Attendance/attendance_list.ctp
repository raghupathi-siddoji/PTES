	 ...
	 <div class="row">
		...
		<div class="col-md-12">
			<div class="box box-success">
				...
				<div class="box-body">
					<?php echo $this->Form->create('ClassWiseAttendance',array("url"=>array("controller"=>"Attendance","action"=>"storeAttendance")));?>
				...
				$serial_number=1; foreach($attendance as $attend) { ?>
					<tr>
					...
					<td>
						...
						<?php foreach($holiday as $h) {
							if($a==$h && $a!=$d)
								{
									echo $this->Form->input("day$a.",array('type'=>'select','class'=>'holiday','options'=>array('H'=>'H','RH'=>'RH','SH'=>
									'SH','NH'=>'NH','LH'=>'LH','OH'=>'OH'),"readonly","label"=>false,"size"=>"1"));
									$f=1;
									$hDay=1;
									$d=$a;
								}
							...
							if($f==0 && $a<=$last)
								echo $this->Form->input("day$a.",array('type'=>'select','options'=>array('P'=>'P','A'=>'A','L'=>'L','HL'=>'HL'),"required","label"=>false,"size"=>"1")); 
							else if($last<$a)
				...
				<div class="form-group">
					<div class="row">
						...
						<div class="col-md-4">
							<a href="../Attendance/classWiseAttendance" class="btn btn-warning btn-sm pull-right">Cancel</a></h4>
						</div>
					</div>
				</div>
