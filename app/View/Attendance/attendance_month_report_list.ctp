 ...
 <!-- Content Wrapper. Contains page content -->
  <div class="content-wrapper">
	...
	<?php echo $this->Html->link('<i class="btn btn-info btn-sm pull-right">Print</i>',array('controller'=>'Attendance','action'=>'printAttendance',$id),array('escape'=>false,'target'=>'_blank'))?>
				...
				<div class="col-md-1">
	<?php echo $this->Html->link('<i class="btn btn-warning btn-sm pull-right">Go Back</i>',array('controller'=>'Attendance','action'=>'attendanceMonthReport'),array('escape'=>false)) ;?>
				</div>
			</div>
		</div>
			<div class="box-body ">
