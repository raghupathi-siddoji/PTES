	 ...
	 <div class="row">
		...
		<div class="col-md-6">
         <div class="box box-success">
			...
			<div class="row">
				<div class="col-md-8"><h4>Update Attendance</h4></div>
				<div class="col-md-4">
					<?php echo $this->Html->link('<i class="btn btn-info btn-sm pull-right">Attendance List</i>', array("controller"=>"Attendance","action"=>"classWiseAttendance"),array("escape"=>false)); ?>
				 </div>
			</div>
			</div>
			<div class="box-body">
				
		           <?php echo $this->Form->create('ClassWiseAttendance',array("url"=>array("controller"=>"Attendance","action"=>"updateAttendanceList")));?>
					...
					<div class="form-group">	
						<div class="row">
							...
							<div class="col-md-6"><label>Month<span class="mandatory_fields"> * </span></label>
								<?php echo $this->Form->input('month',array('type'=>'select','label'=>false,"required","class"=>"form-control select_box",'empty'=>'Select Month',
