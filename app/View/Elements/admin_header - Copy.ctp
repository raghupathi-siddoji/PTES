		...
		<div class="navbar-custom-menu">
            <ul class="nav navbar-nav"> 
              ...
              <li class="user-footer"> 
				...
				<?php echo $this->Form->create('AdminLogin',array("url"=>array("controller"=>"Admin","action"=>"adminSignout"))); ?>
				  <?php echo $this->Form->submit('Sign Out',array("class"=>"btn btn-default"),array("escape"=>false));?>
          ...
          <ul class="sidebar-menu">
            ...
            <li class="treeview">
              ...
              <ul class="treeview-menu">
				...
				<li><?php echo $this->Html->link('<i class="fa fa-circle-o"> Fee Assign for RTE</i>',
				  ...
				  <li><?php echo $this->Html->link('<i class="fa fa-circle-o"> List of Fee Collecion</i>',
			...
			<li class="treeview">
              ...
              <ul class="treeview-menu"> 
				  ...
				  <li><?php echo $this->Html->link('<i class="fa fa-circle-o"> Study Certificate for CET</i>',
				  array("controller"=>"Report","action"=>"CetstudyCertificate"),array("escape"=>false));?></li>
