...
<br>
            <!-- form start -->
           <?php echo $this->Form->create('',array("url"=>array("controller"=>"Setting","action"=>"section")));?>
		   
              <div class="box-body">
                <div class="form-group">
					<div class="row">
						<div class="col-sm-3"><label>Section</label></div>
						<div class="col-sm-5">
						<?php 
        ...
        <div class="col-md-6">
          ...
          <div class="box box-warning">
			  <div class="box-body">
				...
				<thead>
					<tr><th>#</th><th>Section</th><th>Delete</th><th>Edit</th></tr>
				</thead>
				<!--	<?php	$i=1;	
					foreach($list as $lt) {?>
					<tr><td><?php echo $i++; ?></td>
