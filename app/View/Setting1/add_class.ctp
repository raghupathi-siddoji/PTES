...
<br>
            <!-- form start -->
           <?php echo $this->Form->create('',array("url"=>array("controller"=>"Setting","action"=>"addClass")));?>
                ...
                <div class="form-group">
					<div class="row">
						...
						<?php 
							...
							echo $this->Form->input('class',array("type"=>"text","class"=>"form-control","required","label"=>false));?>
						</div>
        ...
        <div class="col-md-6">
          ...
          <div class="box box-warning">
			  <div class="box-body">
				...
				<thead>
					<tr><th>#</th><th>Class</th><th>Delete</th><th>Edit</th></tr>
				</thead>
				<!--	<?php	$i=1;	
					foreach($list as $lt) {?>
					<tr><td><?php echo $i++; ?></td>
