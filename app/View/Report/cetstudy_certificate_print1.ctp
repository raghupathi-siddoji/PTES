...
<div class="background">
		...
		<table width="710px" border="0" align="center" > 
		  ...
		  <tr>
			<td>&nbsp;</td>
			<td colspan="6" style="font-size:18px;font-style:italic;line-height:35px;text-align:justify">This is to CERTIFY that&nbsp; Kumar / Kumari <span style="font-size:20px;font-weight:bolder;"><?php echo $study_certificate_details['StudentDetail']['student_name'];?> <?php echo $gender;?> <?php echo $father_name;?> 
