...
<div class="row">	
	<div class="col-md-12">
	 <?php echo $this->Form->create('LanguageAllocation',array("url"=>array("controller"=>"Student","action"=>"updateLanguage")));?>
		<div class="box box-warning">
			...
			<div class="box-body">
			<?Php foreach($lang as $exam_value) { ?>
				<?php echo $this->Form->input('detail_id',array("type"=>"hidden","value"=>$exam_value['LanguageAllocation']['language_allocation_detail_id'])); ?>
			...
			<?php break; } ?>
				...
				<tbody>
					<?php $number=1; foreach($lang as $student_value) {
						...
						<?php echo $this->Form->input('id.',array("type"=>"hidden","value"=>$student_value['LanguageAllocation']['id'])); ?>
						<tr>
							<td><?php echo $number++; ?></td>
							<td><?php echo $student_value['StudentDetail']['student_name']; ?></td>
						    <td><?php echo $this->Form->input('language_1.',array('type'=>'select','label'=>false,'options'=>array($listLanguage),'default'=>$student_value['LanguageAllocation']['language_1'],"required","class"=>"form-control select_box")); ?></td>
						    <td><?php echo $this->Form->input('language_2.',array('type'=>'select','label'=>false,'options'=>array($listLanguage),'default'=>$student_value['LanguageAllocation']['language_2'],"required","class"=>"form-control select_box")); ?></td>
						    <td><?php echo $this->Form->input('language_3.',array('type'=>'select','label'=>false,'options'=>array($listLanguage),'default'=>$student_value['LanguageAllocation']['language_3'],"required","class"=>"form-control select_box")); ?></td>
						</tr>
					<?php } ?>
				</tbody>
				</table>
