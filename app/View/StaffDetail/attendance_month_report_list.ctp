	 ...
	 <div class="row">
		...
		<div class="col-md-12">
          <div class="box box-success">
			...
			$id=$detail['StaffAttendanceDetail']['id']; ?>
			<div class="row"><div class="col-md-4">Academic Year : <?php echo $detail['AcademicYear']['academic_year']; ?></div>
				<div class="col-md-8">	
			...
			<div class="row"><div class="col-md-4">Month : <?php echo $detail['StaffAttendanceDetail']['month']; ?></div></div>
			<?php } ?>
