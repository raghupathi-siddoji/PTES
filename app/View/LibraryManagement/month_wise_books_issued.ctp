		  ...
		  <div class="box-header with-border">
			<div class="row">
				...
				<div class="col-md-1">
					...
					array('controller'=>'LibraryManagement','action'=>'monthWiseBooksIssuedPrint',$from_date,$to_date),array('escape'=>false,'target'=>'_blank'))?>
				</div>
				<div class="col-md-1">
					<?php echo $this->Html->link('<i class="btn btn-warning btn-sm pull-right">Go Back</i>',
					array('controller'=>'LibraryManagement','action'=>'monthWiseReport'),array('escape'=>false))?>
				</div>
			</div>
			</div>
