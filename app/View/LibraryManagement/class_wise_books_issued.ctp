 ...
 <div class="wrapper"> 
	...
	<?php if(!empty($book_list)){ ?>
        <!-- left column -->
		<?php $clas_id=$this->request->data['BookIssue']['add_class_id']; ?>
		<?php $aca_id=$this->request->data['BookIssue']['academic_year_id']; ?>
		<?php $from_date=$this->request->data['BookIssue']['from_date']; ?>
		<?php $to_date=$this->request->data['BookIssue']['to_date']; ?>
	<div class="row">
		<div class="col-md-12">
		  ...
		  <div class="box-header with-border">
			<div class="row">
				...
				<div class="col-md-1">
					...
					array('controller'=>'LibraryManagement','action'=>'classWiseBooksIssuedPrint',$clas_id,$aca_id,$from_date,$to_date),array('escape'=>false,'target'=>'_blank'))?>
				</div>
				<div class="col-md-1">
					<?php echo $this->Html->link('<i class="btn btn-warning btn-sm pull-right">Go Back</i>',
					array('controller'=>'LibraryManagement','action'=>'classWiseReport'),array('escape'=>false))?>
				</div>
			</div>
			</div>
		   ...
		   <p align="center" style="font-size:16px;color:red;"> <?php echo "From : ".date('d-M-Y',strtotime($from_date))." To : ".date('d-M-Y',strtotime($to_date)); ?></p>
				...
				<thead>
				<tr><th>Sl.No</th><th>Student Name</th><th>Student Code</th><th>Student Class</th><th>Unique Code</th><th>Book Code</th><th>Book Name</th><th>Author</th>
