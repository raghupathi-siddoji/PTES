      ...
      <div class="content-wrapper">
		...
		<br>
					<div class="box-header with-border">
					  <h3 class="box-title">Generate Question Paper</h3>
					</div>
					<!-- form start -->
				<!--   <?php echo $this->Form->create('Category',array("url"=>array("controller"=>"Admin","action"=>"addcategory")));?> -->
					  ...
					  <div class="box-body">
						<div class="form-group">
							...
							<br>
							<div class="row">
								<div class="col-sm-5"><label>Exam Type</label></div>
									<div class="col-sm-7">
									 <div class="form-group">
									  <select class="form-control">
							...
							<br>
							<div class="row">
								<div class="col-sm-5"><label>Time</label></div>
									<div class="col-sm-7">
									 <div class="form-group">
							...
							<div class="row">
								...
								<div class="col-sm-4"><?php echo $this->Form->submit('Add Question',array("class"=>"btn btn-info"));?></div>
								<div class="col-sm-4"></div>
						   </div>
						</div>
        ...
        <div class="col-md-6">
          ...
          <div class="box box-warning">
			  <div class="box-body">
				...
				<thead>
				<tr><th>#</th><th>Class </th><th>Subject </th><th>Order Series</th><th>Delete</th><th>Edit</th></tr>
				</thead>
