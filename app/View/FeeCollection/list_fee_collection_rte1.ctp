  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">List of RTE Fee Collection</li>
      </ol>
    </section>
						...
						<div class="box box-warning"> 
							<div class="box-header with-border">
								<div class="row">
									...
									<div class="col-md-6">
										<?php echo $this->Form->input("academic_year_id",array("type"=>"select","options"=>$academic_year_array,"class"=>"form-control select_box","empty"=>"select","required"));?>		
									</div>
  ...
  <!------------ Add Category  ----------->
		...
		<div class="row">
		   ...
		   <div class="col-md-3"> </div> 
			<div class="col-md-3">
				<?php //echo $this->Html->link("Add RTE Fee",array("controller"=>"FeeCollection","action"=>"feeCollectionRte"),array("escapse"=>false,"class"=>"btn btn-info"))?></div>
				<?php echo $this->Html->link("Add RTE Fee",array("controller"=>"FeeCollection","action"=>"feeCollectionRte"),array("escapse"=>false,"class"=>"btn btn-info"))?></div>
		</div>
