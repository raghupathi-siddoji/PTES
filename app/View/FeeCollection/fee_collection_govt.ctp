 ...
 <!-- Content Wrapper. Contains page content -->
  <div class="content-wrapper">
	...
	<div class="row"> 
		...
		<?php echo $this->Form->create('GovtFeeCollection',array("url"=>array("controller"=>"FeeCollection","action"=>"feeCollectionGovt")));?>
	...
	<?php echo $this->Form->create('GovtFeeCollection',array("url"=>array("controller"=>"FeeCollection","action"=>"feeCollectionGovtProcess")));?>
			...
			<div class="col-md-8"> 
				<div class="box box-warning">			
					<div class="box-body">
						...
						<div class="row"> 
							<div class="col-md-6"><label>MPM/Non MPM :</label><?php echo $student_details['StudentDetail']['mpm_employee'];?></div>
							<div class="col-md-2"> <label >Caste :</label> </div>
									...
									{ 
										...
										foreach($fee_details['FeeClassWiseDetails'] as $details) 
										{
											...
											<tr>
												...
												<td><?php echo $this->Form->input("GovtFeeCollectionDetail.fee_paying_amount.",array("type"=>"text","id"=>"fee_paying_amount"."$i","value"=>"0.0","size"=>"10","label"=>false,"onKeyUp"=>"doPaying()","autocomplete"=>"off","onkeypress"=>"return isNumber(event)","maxlength"=>"8"))?></td>
											</tr>
											<?php $i++;
										}
						...
						<div class="row">
							...
							<div class="row">
								<div class="form-horizontal">		
									...
									<div class="col-md-5"><?php echo $this->Form->input("fine_amount",array("type"=>"text","class"=>"form-control","label"=>false,'value'=>"0.0","id"=>"fine_amount","onkeypress"=>"return isNumber(event)","maxlength"=>"8")); ?></div>
								</div>
							</div>
							<div class="row">
								<div class="form-horizontal">	
						...
						<div class="row">
							...
							<div class="col-md-2"><?php echo $this->Form->submit("Collection",array("class"=>"btn btn-info","onclick"=>"return validate()"));?></div>
							<div class="col-md-5"><?php echo $this->Html->link("Cancel",array("controller"=>"FeeCollection","action"=>"listFeeCollectionGovt"),array("escapse"=>false,"class"=>"btn btn-info"))?></div>
						</div>
					</div>
				</div>
			</div> 
