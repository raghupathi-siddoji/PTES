...
<table width="49%" border="1" id="main_table" style="border-collapse:collapse;font-size:85.0%" rules="groups" cellpadding="4px">
 ...
 <tr>  
    <td colspan="8" align="center"><b class="heading">Management Fee Receipt</b></td> 
  </tr>
  <tr>  
  ...
  <tr>
    ...
    <td width="19%" align="left"><?php echo date('d-m-Y',strtotime($receipt_details['FeeCollection']['receipt_date']));?></td>
    <td>&nbsp;</td>
  </tr>
  <tr>
    ...
    <td><strong>:</strong></td>
    <td align="left"><?php echo $receipt_details['FeeCollection']['receipt_no'];?></td>
    <td>&nbsp;</td>
  </tr>
  <tr>
    ...
    <td colspan="8">
      ...
      <tr>
		...
		<tr>
			...
			<th align="right"><?php echo $receipt_details['FeeCollection']['payable_amount'];?></th>
		</tr>
		<tr>
			<th> </td>
			<th align="right">Total Paid Amount</th>
			<th align="right"><?php echo $receipt_details['FeeCollection']['paid_amount'];?></th>
		</tr>
		<tr>
			<th> </td>
			<th align="right">Now Paying Amount</th>
			<th align="right"><?php echo $receipt_details['FeeCollection']['paying_amount'];?></th>
		</tr>
		<tr>
			<th> </td>
			<th align="right">Balance to be Pay</th>
			<th align="right"><?php echo $receipt_details['FeeCollection']['balance_amount'];?></th>
		</tr>
    </table></td>
  </tr>
  <tr>
  ...
  <tr>
    <td colspan="8"><strong>In Words: <?php echo $this->NumberToWord->convert_number_to_words($receipt_details['FeeCollection']['paying_amount']);?> only </strong></td>
  </tr>
  <tr>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
  ...
  <tr> 
    ...
    <td colspan="4" align="left"><strong>Next Payment Date:<?php echo date('d-m-Y',strtotime($receipt_details['FeeCollection']['next_payment_date']));?></strong></td> 
    <td colspan="3" align="right"><strong>Signature</strong></td>
   <td>&nbsp;</td>
  </tr>
</table>
<br><span style="margin-left:518px;margin-top:-200px">|</span>
<!-- table two -->
<table width="49%" border="1" id="main_table" style="border-collapse:collapse;font-size:85.0%;margin-left:530px;margin-top:-700px" rules="groups" cellpadding="4px">
  <tr>
    <td width="18%" rowspan="2s" align="center"><img src="../../img/logo.jpg" width="80px"></td>
    <td width="2%">&nbsp;</td>
    <td colspan="5" align="left"><strong class="main_heading"> PAPER TOWN ENGLISH SCHOOL</h2></strong></td>
