 ...
 <!-- Content Wrapper. Contains page content -->
  <div class="content-wrapper">
	...
	<div class="row"> 
		...
		<?php echo $this->Form->create('FeeCollection',array("url"=>array("controller"=>"FeeCollection","action"=>"feeCollectionManagement")));?>
	...
	<?php echo $this->Form->create('FeeCollection',array("url"=>array("controller"=>"FeeCollection","action"=>"feeCollectionManagementProcess")));?>
				...
				<div class="box box-warning">			
					<div class="box-body">
						...
						<div class="row">
							...
							<div class="col-md-4"><?php echo $this->Form->input("receipt_no",array("type"=>"text","value"=>$gove_receipt,"id"=>"fee",'label'=>false,"class"=>"auto_generate","readonly")); ?></div>
						</div>
						...
						<div class="row">
							...
							<div class="col-md-4"><?php echo $this->Form->input("receipt_date",array("type"=>"text","value"=>date('d-m-Y'),"id"=>"datepicker",'label'=>false)); ?></div>
						</div>
						<div class="row"> 
									...
									{ 
										...
										foreach($fee_details['FeeClassWiseDetails'] as $details) 
										{
											...
											<tr>
												...
												<td><?php echo $this->Form->input("FeeCollectionDetail.fee_paying_amount.",array("type"=>"text","id"=>"fee_paying_amount"."$i","value"=>"0.0","size"=>"10","label"=>false,"onKeyUp"=>"doPaying()","autocomplete"=>"off","onkeypress"=>"return isNumber(event)"))?></td>
											</tr>
											<?php $i++;
										}
						...
						<div class="row">
							...
							<div class="row">
								<div class="form-horizontal">
									...
									<div class="col-md-5"><?php echo $this->Form->input("paying_amount",array("type"=>"text","id"=>"paying_amount","class"=>"form-control calculation_text",
									 "required","label"=>false,"maxlength"=>"8","onkeypress"=>"return isNumber(event)")); ?></div>
								</div>
							</div>  
							...
							<div class="row">
								<div class="form-horizontal">	
									...
									<div class="col-md-5"><?php echo $this->Form->input("balance_amount",array("type"=>"text","class"=>"form-control calculation_text","id"=>"balance_amount","label"=>false,"value"=>$total_balance,"onFocus"=>"doFine()","readonly")); ?></div>
								</div>
							</div>
							</div>
						</div>
						...
						<div class="row">
							<div class="col-md-5"><b style="color:blue"><!--Govt Fee Paid--></b> <?php //echo $govt_student_paid_amount;?></div>
