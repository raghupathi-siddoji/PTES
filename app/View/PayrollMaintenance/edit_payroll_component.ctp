			 ...
			 <div class="row">
				...
				<div class="col-md-6">
				  <div class="box box-success"> 
					...
					<!-- form start -->
					<?php echo $this->Form->create('PayrollComponent',array("url"=>array("controller"=>"PayrollMaintenance","action"=>"editPayrollComponent")));?>
					 <?php echo $this->Form->input('PayrollComponent.id');?>
					  <div class="box-body">
						<div class="form-group">
							<div class="row">
								<div class="col-sm-5"><label>Employee Id / Name </label></div>
									<div class="col-sm-7">
									 <div class="form-group">
									  <?php
        ...
        <div class="col-md-6">
          ...
          <div class="box box-warning">
			  <div class="box-body">
				...
				<thead>
					<tr><th>Sl.No</th><th> Name </th><th>Employee Id </th><th>Component</th><th>Action</th></tr>
				</thead>
				<?php 
					$j=1;
					$i=0;
					...
					<tr>
						...
						<td><a href="" data-toggle="modal" data-target="#student">View</a></td>
						<td> <?php echo $this->Html->link('<i class="fa fa-trash-o" ></i>',
							...
							<?php echo $this->Html->link('<i class="fa fa-pencil" ></i>',
											array("controller"=>"PayrollMaintenance","action"=>"payrollComponent", $id),
