				...
				<div class="col-md-6">
				  <div class="box box-success"> 
					<div class="box-header with-border">
					  <h3 class="box-title">Monthly Remmitance List</h3>
					</div>
					<!-- form start -->
				   <?php echo $this->Form->create('StaffPayroll',array("url"=>array("controller"=>"PayrollMaintenance","action"=>"monthlyRemmitanceList")));?>
					  ...
					  <div class="form-group"> 
							<div class="row">
								...
								<div class="col-sm-6"> 
									<?php echo $this->Form->input("academic_year_id",array("type"=>"select","options"=>$academic_year_array,"label"=>false,"class"=>"form-control select_box","empty"=>"select","required"));?>		
								</div>
						...
						<div class="form-group"> 
							<div class="row">
								...
								'5'=>'May','6'=>'June','7'=>'July','8'=>'August','9'=>'September','10'=>'October','11'=>'November','12'=>'December');?>  
										<?php echo $this->Form->input("month",array("type"=>"select","options"=>$month,"label"=>false,"class"=>"form-control select_box","empty"=>"select","required"));?>		  
									</div>
									<div class="col-sm-2">&nbsp;</div>
							</div>
						</div> 
