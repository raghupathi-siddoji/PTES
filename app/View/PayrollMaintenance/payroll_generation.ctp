			 ...
			 <div class="row">
				...
				<br>
					<div class="box-header with-border">
					  <h3 class="box-title">Payroll Generation</h3>
					</div>
					<!-- form start -->
				   <?php echo $this->Form->create('StaffPayroll',array("url"=>array("controller"=>"PayrollMaintenance","action"=>"payrollGeneration")));?>
				   
					  <div class="box-body"> 
					  <div class="form-group"> 
							<div class="row">
								<div class="col-sm-4"><label>Academic Year <span class="mandatory_fields">*</span></label></div>
								<div class="col-sm-6"> 
						...
						<div class="form-group"> 
							<div class="row">
								<div class="col-sm-4"><label>Month <span class="mandatory_fields">*</span></label></div>
								<div class="col-sm-6">  
						...
						<div class="form-group"> 
							<div class="row">
								...
								<div class="col-sm-6">
								<?php  
									//echo $this->Form->input('payment_date',array("type"=>"text","class"=>"form-control","label"=>false,"placeholder"=>"dd/mm/yyyy","id"=>"datepicker","value"=>date('d/m/Y')));?>
								</div>
								<div class="col-sm-2">&nbsp;</div>
							</div>
						</div>  
							<div class="row">
								...
								<div class="col-sm-4"><?php echo $this->Form->submit('Generate',array("class"=>"btn btn-info"));?></div>
								<div class="col-sm-4"></div>
						   </div>
