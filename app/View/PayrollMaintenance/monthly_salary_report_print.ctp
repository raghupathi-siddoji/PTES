...
<body onload="print();" onfocus="window.close()">
		<?php $ay = $monthly_payroll_list[0]['StaffPayroll']['academic_year_id'];
			$month = $monthly_payroll_list[0]['StaffPayroll']['month']; ?>
					  ...
					  <center><h3>Salary List for the month of <?php echo  $monthName = date("F", mktime(0, 0, 0, $month));?></h3></center>
						...
						<table width="100%" border="0">
						  ...
						  <tr>
							<td width="23%">&nbsp;</td>
							<td width="19%">Accountant</td>
							<td width="17%">&nbsp;</td>
							<td width="28%">Head Master</td>
							<td width="13%">Treasurer</td>
						  </tr>
						</table>
	</body>
</html>					 
