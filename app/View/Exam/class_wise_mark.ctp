	 ...
	 <div class="row">
		...
		<div class="col-md-8">
         <div class="box box-success">
			<div class="box-header with-border"><h4>Class Wise Marks List</h4>	</div>
		
			<div class="box-body">
				<div class="form-group">
		           <?php echo $this->Form->create('MarksEntry',array("url"=>array("controller"=>"Exam","action"=>"classWiseMarkList")));?>
				...
				<div class="row">
				  <div class="col-md-4"></div>
				    <div class="col-md-4">
						<?php echo $this->Form->submit('Show Marks List',array("class"=>"btn btn-info pull-right form-control"));?>
					</div>
				  <div class="col-md-4"></div>
				</div>
				</div>
