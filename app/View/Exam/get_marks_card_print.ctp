...
<body onload="print()">
<table width="1011"  id="id1" onclick="print()">
...
<td width="300"><span class="style1">Name : <?php echo $list['StudentDetail']['student_name'];?>  </span></td>
        ...
        <td width="180" align="center"><span class="style1">Class : <?php echo $list['AddClass']['class_name']; ?></span></td>
 ...
 <table>
  <tr>
    <td width="277" height="80"><div align="left"><span style="vertical-align:bottom;" align="center">Result : </span></div></td>
