...
class ImageResizeComponent extends Component {
	 ...
	 * @var string
	 */
	var $resizeTmpFile = '$tmp_name';
	
	/**
	 * Path where the uploaded images will be stored.
	 * @var unknown_type
	 */
	var $file_path = '/Ontimecity.com/app/webroot/ProductImages/';
	...
	function startup(Controller $controller) {
		...
		//echo $this->file_path = env('DOCUMENT_ROOT') . $this->file_path;
		$this->file_path = env('DOCUMENT_ROOT') . $this->file_path;
		//echo $this->resizeTmpFile = env('DOCUMENT_ROOT') . $this->resizeTmpFile;
